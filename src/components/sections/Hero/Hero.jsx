...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', url: `mailto:${personalInfo.email}`, icon: (
      ...
      <div className="hero__container">
        ...
        <div className={`hero__visual ${isVisible ? 'hero__visual--visible' : ''}`}>
          <div className="hero__image-wrapper">
            {/* For PNG: no ball, just the modern-card hero image */}
            <img 
